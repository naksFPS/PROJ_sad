...
public class CartListActivity extends AppCompatActivity {
    ...
    private void calculateCard() {
        double percentDiscount = 0.3; //30%discount for example
        double delivery = 10;

        double discount = Math.round((managementCart.getTotalFee() * percentDiscount) * 100.0) / 100.0;
        double subtotal = Math.round((managementCart.getTotalFee() - discount) * 100.0) / 100.0;
        ...
        // Display the values
        totalFeeTxt.setText("₱" + subtotal); // Display subtotal after discount
        taxTxt.setText("-₱" + discount); // Display the discount amount
    ...
    private void initView() {
        ...
        taxTxt = findViewById(R.id.discountTxt);
